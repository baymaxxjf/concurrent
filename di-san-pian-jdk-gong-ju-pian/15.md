...
整体架构\(列举常用的容器类\) ![](../.gitbook/assets/bing-fa-rong-qi.png)

其中，阻塞队列（BlockingQueue）在[第十三章](https://github.com/baymaxxjf/concurrent/tree/c0f458769a889c236292ec0e20e376aae9aee21b/article/03/13.html)有介绍，CopyOnWrite容器（CopyOnWritexxx）在[第十六章](https://github.com/baymaxxjf/concurrent/tree/c0f458769a889c236292ec0e20e376aae9aee21b/article/03/16.html)有介绍，这里不做过多介绍。
...
有些方法需要跨段，比如size\(\)、isEmpty\(\)、containsValue\(\)，它们可能需要锁定整个表而而不仅仅是某个段，这需要按顺序锁定所有段，操作完毕后，又按顺序释放所有段的锁。如下图： ![](https://github.com/baymaxxjf/concurrent/tree/c0f458769a889c236292ec0e20e376aae9aee21b/Users/yxiao/book/concurrent/article/03/imgs/分段锁机制.png)
